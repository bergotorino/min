...
// -----------------------------------------------------------------------------
Min::AvailableCasesTreeModel::AvailableCasesTreeModel(QObject *parent)
...
// -----------------------------------------------------------------------------
Min::AvailableCasesTreeModel::~AvailableCasesTreeModel()
{
    delete root_;
}
// -----------------------------------------------------------------------------
QVariant Min::AvailableCasesTreeModel::data(const QModelIndex &index,
                                            int role) const
{
...
// -----------------------------------------------------------------------------
Qt::ItemFlags Min::AvailableCasesTreeModel::flags(const QModelIndex &i) const
{
    if (!i.isValid()) return 0;
    return Qt::ItemIsEnabled | Qt::ItemIsSelectable | Qt::ItemIsUserCheckable;
}
// -----------------------------------------------------------------------------
QVariant Min::AvailableCasesTreeModel::headerData(int section,
...
// -----------------------------------------------------------------------------
QModelIndex Min::AvailableCasesTreeModel::index(int row, int column,
...
// -----------------------------------------------------------------------------
QModelIndex Min::AvailableCasesTreeModel::parent(const QModelIndex &index) const
{
...
// -----------------------------------------------------------------------------
int Min::AvailableCasesTreeModel::rowCount(const QModelIndex &parent) const
{
...
// -----------------------------------------------------------------------------
int Min::AvailableCasesTreeModel::columnCount(const QModelIndex &parent) const
{
    if (parent.isValid()) {
        Min::TreeItem *tmp;
...
#include <QFile>
#include <QStringList>
void Min::AvailableCasesTreeModel::setupModelData()
{
/*    QStringList list;
    QList<QVariant> data;
    data << "DemoModule";

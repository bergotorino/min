...
#ifndef INCLUDED_MIN_TESTRUNTREEMODEL_HPP
#define INCLUDED_MIN_TESTRUNTREEMODEL_HPP
...
namespace Min
{
     ...
     * structure
     */
    class TestRunTreeModel: public QAbstractItemModel
    {
    Q_OBJECT
    public:
        /** Default C++ Constructor. */
        TestRunTreeModel(QObject *parent);
    ...
    private:
        ...
        /** Copy Constructor. */
        TestRunTreeModel( const Min::TestRunTreeModel& c );
        /** Assignment operator. */
        Min::TestRunTreeModel& operator =(const Min::TestRunTreeModel& c);
        /**@}*/
...
// -----------------------------------------------------------------------------
#endif // INCLUDED_MIN_TESTRUNTREEMODEL_HPP (file created by generator.sh v1.08)

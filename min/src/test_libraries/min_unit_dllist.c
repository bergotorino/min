...
/**
 *  @file       min_unit_dllist.c
 *  @version    0.1
 *  @brief      dllist CHECK test cases ported to MINUnit
 */
...
LOCAL int       equal (const void *a, const void *b);
...
#include "min_unit_dllist_cases.c"

...
/**
 *  @file       minqtdbtests.hpp
 *  @version    0.1
 *  @brief      This file contains header file of the TemplateScriptminqtdbtests 
 *              test module of MIN Test Framework.
 */

#ifndef MIN_MINQTDBTESTS_H
#define MIN_MINQTDBTESTS_H
/* ------------------------------------------------------------------------- */
/* INCLUDES */
extern "C" {
